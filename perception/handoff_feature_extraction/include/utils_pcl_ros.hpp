...
void
fillRosMessage (handoff_feature_extraction::Features &outRosMsg, const pc_cluster_features &inObjFeatures);

void
objectPoseTF(geometry_msgs::Transform geom_transform);

void
getObjectMarker(visualization_msgs::Marker &marker, handoff_feature_extraction::Features &feats);
