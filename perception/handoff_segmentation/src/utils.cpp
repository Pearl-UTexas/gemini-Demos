...
parseArguments(int argc, char **argv, parsedArguments &pA, ros::NodeHandle &nh)
{
 ...
 // {
      if (nh.getParam("segmentation/v", val))
      {
          pA.hue_val = val;
      }
      if (nh.getParam("segmentation/t", val))
      {
          pA.hue_thresh = val;
      }
      if (nh.getParam("segmentation/z", val))
      {
          pA.z_thresh = val;
      }
      if (nh.getParam("segmentation/e", val))
      {segmentation
          pA.euc_thresh = val;
      }
      if (nh.getParam("segmentation/p", bVal))
      {
          pA.pre_proc = bVal;
      }
      if (nh.getParam("segmentation/c", iVal))
      {
          pA.seg_color_ind = iVal;
      }
      if (nh.getParam("segmentation/m", bVal))
      {
          pA.merge_clusters = bVal;
      }
      if (nh.getParam("segmentation/dt", val))
      {
          pA.ecc_dist_thresh = val;
      }
      if (nh.getParam("segmentation/ct", val))
      {
          pA.ecc_color_thresh = val;
      }
      if (nh.getParam("segmentation/src", iVal))
      {
    	  pA.pc_source = iVal;
      }
      if (nh.getParam("segmentation/out", iVal))
      {
          pA.output_type = iVal;
      }
      if (nh.getParam("segmentation/comm", iVal))
      {
    	  pA.comm_medium = iVal;
      }
      if (nh.getParam("segmentation/rt", sVal))
      {
          sprintf(pA.ros_topic, "%s", sVal.c_str());
      }
      if (nh.getParam("segmentation/b", iVal))
      {
          pA.displayAllBb = iVal;
      }
      if (nh.getParam("segmentation/sh", iVal))
      {
          pA.saturation_hack = iVal;
      }
      if (nh.getParam("segmentation/st", val))
      {
          pA.saturation_hack_value = val;
      }
      if (nh.getParam("segmentation/sv", val))
      {
          pA.saturation_mapped_value = val;
      }
      if (nh.getParam("segmentation/ri", iVal))
      {
          pA.robot_id = iVal;
      }
      if (nh.getParam("segmentation/pr", iVal))
      {
    	  pA.freenectProcessor = iVal;
      }
      if (nh.getParam("segmentation/fn", iVal))
      {
    	  pA.filterNoise = iVal;
      }
      if (nh.getParam("segmentation/nv", bVal))
      {
    	  pA.viz = !bVal;
      }
      if (nh.getParam("segmentation/view", iVal))
      {
    	  pA.justViewPointCloud = iVal; 
      }
      if (nh.getParam("segmentation/h", bVal))
      {
