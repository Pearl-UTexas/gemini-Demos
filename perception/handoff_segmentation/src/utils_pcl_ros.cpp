...
void
fillRosMessage (handoff_segmentation::Features &outRosMsg, const pc_cluster_features &inObjFeatures)
{
...
void getObjectMarker(visualization_msgs::Marker &marker, handoff_segmentation::Features &feats)
{
